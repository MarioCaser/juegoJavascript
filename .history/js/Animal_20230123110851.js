class Animal {
    ...
    show() {
    console.log(Animal ID: ${this.id}, Type: ${this.type}, Points: ${this.points}, State: ${this.state}, Size: ${this.size}, Speed: ${this.speed});
    }
    
    kill() {
    this.state = "dead";
    console.log(Animal ID: ${this.id} has been killed);
    }
    }
